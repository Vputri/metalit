<template>
  ...
  >
    <div class="bg-white rounded-lg shadow-xl w-full max-w-lg md:max-w-2xl p-6 md:p-8 relative">
      ...
      <h2
        class="font-poppins font-bold text-xl md:text-2xl leading-normal tracking-normal text-[#262626] mb-1 text-center"
      >
        Upload CV
      </h2>
      <p
        class="font-poppins font-normal text-base md:text-lg leading-normal tracking-normal text-[#262626] mb-6 text-center"
      >
        {{ jobTitle }}
      </p>
      ...
      <form @submit.prevent="submitForm">
        <div class="mb-4">
          ...
          >
            <p
              class="font-poppins font-normal text-sm leading-normal tracking-normal text-[#939393] mr-2"
            >
        ...
        <div class="flex justify-end space-x-4">
          <button
            type="button"
            class="px-6 py-2 border border-gray-300 text-[#262626] rounded-lg hover:bg-gray-100 transition duration-300 font-poppins font-normal text-base leading-normal tracking-normal"
            @click="closePopup"
          >
            Cancel
          </button>
          <button
            type="submit"
            class="px-6 py-2 bg-[#0F5DA9] text-white rounded-lg hover:bg-blue-700 transition duration-300 font-poppins font-semibold text-base leading-normal tracking-normal"
          >
            Submit
          </button>
        </div>
