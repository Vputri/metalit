<template>
  <div class="bg-gray-50 p-8 rounded-xl shadow-md">
    <form class="space-y-8" @submit.prevent="handleSubmit">
      <!-- Judul Form: Registration Form -->
      <h2
        class="font-poppins font-semibold text-2xl sm:text-3xl md:text-[25px] leading-none tracking-[-1px] capitalize text-gray-900 mb-6 text-center"
      >
        Registration Form
      </h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          ...
          <select
            ...
            class="w-full p-3 rounded-md focus:outline-none bg-gray-50 text-gray-900 font-poppins font-semibold text-lg leading-none tracking-normal"
            required
          >
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          ...
          <select
            ...
            class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900 font-poppins font-normal text-base leading-none tracking-normal"
            required
          >
      ...
      <div class="border-t border-gray-200 pt-8 mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div class="flex">
              <span
                class="inline-flex items-center px-3 text-sm text-gray-900 bg-white border border-r-0 border-gray-300 rounded-l-md font-poppins font-normal text-base leading-none tracking-normal"
              >
                +628
              </span>
              <input
                ...
                type="tel"
                class="rounded-none rounded-r-lg border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-3 bg-white font-poppins font-normal text-base leading-none tracking-normal"
          ...
          <div class="col-span-1">
            ...
            <div class="flex items-center space-x-4">
              <label class="inline-flex items-center">
                ...
                />
                <span
                  class="ml-2 text-gray-700 font-poppins font-normal text-base leading-none tracking-normal"
                  >Male</span
                >
              </label>
              <label class="inline-flex items-center">
      ...
      <div class="border-t border-gray-200 pt-8 mt-8">
        <label
          for="referralCode"
          class="block text-gray-700 text-sm font-semibold mb-2 font-poppins font-normal text-base leading-none tracking-normal"
        >
          Referral Code
        </label>
        <input
