        ...
        <div class="container mx-auto max-w-[90%]">
          ...
          <div class="bg-gray-100 p-6 rounded-lg mb-8">
            ...
            <div class="mb-8">
              ...
              <ul
                class="list-disc list-inside font-poppins font-normal text-base leading-none tracking-normal text-[#262626 space-y-2 pl-4"
              >
            ...
            <div v-if="job.additionalSkills && job.additionalSkills.length > 0">
              ...
              <ul
                class="llist-disc list-inside font-poppins font-normal text-base leading-none tracking-normal text-[#262626 space-y-2 pl-4"
              >
