      ...
      <div class="container mx-auto">
        ...
        <div class="mb-8 relative mx-auto">
          <input
            ...
            class="w-full p-3 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900 font-poppins font-normal text-base leading-normal tracking-normal"
          />
